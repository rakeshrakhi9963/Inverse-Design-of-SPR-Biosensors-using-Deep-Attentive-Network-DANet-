...
selected_metal = input("Enter the metal to simulate (silver, gold, copper, aluminum, graphene): ").strip().lower()
...
thickness_ranges = {
    ...
    'graphene': [1, 2, 3]  # Number of layers
}

# Dataset output
output_file = f'spr_dataset_{selected_metal}.csv'
...
print(f"✅ Dataset generation completed for {selected_metal}. Saved to '{output_file}'")